...
<?php
	...
	if(!empty($_SESSION['Token']) && !empty($_SESSION['Time']))
	{
		if(Verify_LoginToken($_SESSION['Token'],$_SESSION['Time']))
		{
			...
			// for($i=79;$i<=119;$i++)
			// {
				// if (isset($_POST['radiobutton1_'.$i])) $_SESSION['radiobutton1_'.$i] = $_POST['radiobutton1_'.$i];
				// echo $_SESSION['radiobutton1_'.$i.''];
			// }
			?>
			<!--讀入對應的值-->
				...
				<table width="100%" height="auto">
					<tr>
						<td align="center" valign="top">
							<form id="form1" name="form1" method="post" action="personality_calculation.php">
									<font color="#154360"><big><b>第五部份</b></big></font><p><font color="#9B59B6">在下列各個詞語中，你較傾向於哪一個？ (請著重在詞句的 "意思" 上，而不是它們好聽或好看！)</font><p><hr size="1px" align="center" width="80%">
									...
									<?php foreach ($page_questions as $question): ?>
										<tr><td colspan="2" align="center"><font color="#996600"><b><?= "5-" . $Number_Set . "：" . $question['QUESTION'] ?></b></font></td></tr>
										<tr>
											<td align="center" valign="top">
								...
								<input name="Submit1" type="button" value="完成" onClick="check_radio('form1')">
								<p>
								<p>
								<p>
							</form>
