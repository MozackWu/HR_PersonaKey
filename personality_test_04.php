				...
				<table width="100%" height="auto">
					<tr>
						<td align="center" valign="top">
							<form id="form1" name="form1" method="post" action="personality_test_05.php">
									<font color="#154360"><big><b>第四部份</b></big></font><p><font color="#9B59B6">下列答案的描述中，哪一個最貼近您平時思考和行為模式</font><p><hr size="1px" align="center" width="80%">
									...
									<?php foreach ($page_questions as $question): ?>
										<tr><td colspan="2" align="center"><font color="#996600"><b><?= "4-" . $Number_Set . "：" . $question['QUESTION'] ?></b></font></td></tr>
										<tr>
											<td align="center" valign="top">
